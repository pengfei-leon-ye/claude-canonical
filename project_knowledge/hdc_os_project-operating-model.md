...
|---|---|:---:|:---:|---|
| P-01 | [RULE] CCAR §6 ↔ [MECH] CI/CD §2 | SR | C2C | test-type taxonomy or tier-test assignment changes (Hub residue level: CCAR §6 contract testing seam ↔ CI/CD §2 milestone identity) |
...
- **P-17** (was: [RULE] CCAR §5 + §5.3 ↔ `.claude/agents/{agent-name}.md`) — CCAR §5 subagent roster fully migrated to CC substantive CCAR; coupling is now wholly CC-internal
...
- **P-17**: RETIRED in Phase 3 (per [REF] Hub-CD-CC §5.4.4). [RULE] CCAR §5 subagent roster fully migrated to CC substantive CCAR canonical; pairing now wholly CC-internal.

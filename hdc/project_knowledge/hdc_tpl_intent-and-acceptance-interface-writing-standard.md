...
- **Relationship to [MECH] CI/CD Milestone Policy**: §3 owns the semantic disambiguation between `evidence.md` and the milestone-level Test Evidence Report; §3.3 owns the `operator_digest` definition that appears in this source's evidence_required default set
